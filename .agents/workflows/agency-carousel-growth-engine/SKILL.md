...
- **Credential**: `GEMINIENLACE` environment variable (free tier available at https://aistudio.google.com/app/apikey)
...
| ------------------ | ------------------------------------------------ | ---------------------------------------------- |
| `GEMINIENLACE`     | Google API key for Gemini image generation       | https://aistudio.google.com/app/apikey         |
