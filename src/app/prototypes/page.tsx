...
const PrototypePreview = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950">
      {/* Prototype Selector */}
      <div className="fixed top-2 left-1/2 -translate-x-1/2 z-[100] flex gap-2 p-1 bg-card/80 backdrop-blur-xl rounded-full border border-white/10 shadow-2xl overflow-x-auto max-w-[95vw]">
        {tabs.map((tab) => (
          <button
            key={tab.id}
