...
const OperationalDashboard = () => {
  return (
    <div className="min-h-screen bg-[#020617] text-slate-200 font-sans pb-24">
      {/* Header */}
      <header className="flex items-center justify-between p-4 bg-[#0f172a] border-b border-primary/20 sticky top-0 z-50">
        ...
        <section className="bg-gradient-to-br from-[#1e293b] to-[#0f172a] rounded-3xl p-8 border border-white/5 relative overflow-hidden shadow-2xl">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm">Monitoreo de activos críticos y geolocalización.</p>
            </div>
          </div>
          ...
          <div className="flex gap-4">
            <input
              ...
              className="flex-1 bg-slate-900/50 border border-slate-700 rounded-xl px-4 py-4 text-white font-mono text-sm focus:outline-none focus:border-primary transition-colors"
            />
                ...
                <div key={i}>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-slate-950 border border-slate-800 rounded-xl py-4 pl-12 pr-4 text-white focus:outline-none focus:border-primary transition-colors"
                    />
                  </div>
                </div>
              ))}
      ...
      {/* Bottom Nav */}
      <nav className="fixed bottom-0 left-0 right-0 bg-[#0f172a]/90 backdrop-blur-xl border-t border-slate-800 p-4 pb-8 z-50">
