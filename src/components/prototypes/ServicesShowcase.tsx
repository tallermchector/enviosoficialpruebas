    ...
    <div className="min-h-screen bg-[#0a0c14] text-white font-sans pb-24">
      ...
      <main className="p-6">
        ...
        <section className="mt-12 p-8 bg-white/5 rounded-[40px] border border-white/10 backdrop-blur-md text-center">
          ...
          <button className="w-full py-5 bg-primary hover:bg-blue-500 text-white font-black rounded-2xl text-lg transition-all shadow-lg shadow-primary/20 uppercase tracking-widest">
            Contactar Ventas
          </button>
        </section>
      </main>
