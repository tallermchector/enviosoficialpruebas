...
export function EnviosFlexCta() {
  ...
  return (
    <section data-style="glassmorphism" className="glass-section py-24 px-4 bg-[#0a0d16] relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          <div className="inline-flex items-center gap-3 px-4 py-2 rounded-none bg-white/5 border border-white/10 text-white/70 text-xxs font-bold tracking-[0.3em] mb-10 uppercase">
            IMPULSA TU REPUTACIÓN <div className="w-1.5 h-1.5 rounded-none bg-secondary animate-pulse" />
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            ...
            <Button
              ...
              className="px-12 py-5 bg-white/5 hover:bg-white/10 border border-white/10 text-white font-bebas text-lg tracking-wider rounded-none transition-all flex items-center gap-3 uppercase h-auto group"
            >
