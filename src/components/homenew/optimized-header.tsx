  ...
  return (
    <HeaderContainer>
      ...
      <Link href="/" className="flex items-center space-x-2 sm:space-x-3 group shrink-0 min-w-0" aria-label="Volver al inicio desde la cabecera">
        ...
        <span className="font-display text-orbitron font-black text-sm sm:text-lg md:text-2xl tracking-tighter text-slate-900 dark:text-white uppercase italic whitespace-nowrap">
      ...
      <nav className="hidden lg:flex items-center space-x-2 bg-white/[0.03] backdrop-blur-md border border-white/10 rounded-2xl p-1.5 shadow-2xl">
        <ActiveLink 
          href="/" 
          className="text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-white/10"
          activeClassName="bg-primary/10 text-primary dark:bg-primary/20 dark:text-blue-400 border border-primary/30 shadow-lg"
        >
      ...
      <div className="flex items-center gap-4">
        <a href="tel:+5492236602699" aria-label="Llamar al +54 223 660-2699" className="hidden xl:flex items-center gap-3 px-5 py-2.5 rounded-full glass-card text-slate-900 dark:text-slate-200 text-xxs font-black tracking-[0.2em] hover:bg-slate-100 dark:hover:bg-white/10 transition-all uppercase">
