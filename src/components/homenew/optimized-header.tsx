  ...
  return (
    <HeaderContainer>
      ...
      <Link href="/" className="flex items-center space-x-2 sm:space-x-3 group shrink-0 min-w-0" aria-label="Volver al inicio desde la cabecera">
        ...
        <span className="font-display text-orbitron font-black text-sm sm:text-lg md:text-2xl tracking-tighter text-slate-900 uppercase italic whitespace-nowrap">
      ...
      <div className="flex items-center gap-4">
        <a href="tel:+5492236602699" aria-label="Llamar al +54 223 660-2699" className="hidden xl:flex items-center gap-3 px-5 py-2.5 rounded-full glass-card text-slate-900 text-xxs font-black tracking-[0.2em] hover:bg-slate-100 transition-all uppercase">
