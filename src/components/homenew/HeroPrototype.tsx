...
const HeroPrototype = () => {
  return (
    <div className="min-h-screen bg-[#0f172a] text-white font-sans selection:bg-primary selection:text-white">
      {/* Header */}
      <header className="flex items-center justify-between p-4 bg-[#1e293b]/50 backdrop-blur-md sticky top-0 z-50 border-b border-white/10">
        ...
        <button className="p-2 bg-[#1e293b] rounded-lg border border-white/10">
      ...
      <section className="relative px-6 pt-16 pb-24 flex flex-col items-center text-center overflow-hidden">
        ...
        <motion.p
          ...
          className="max-w-md text-lg text-slate-400 mb-10 leading-relaxed"
        >
        ...
        >
          <button className="w-full py-4 bg-secondary text-[#0f172a] font-bold text-lg rounded-xl shadow-[0_4px_0_rgb(180,140,0)] hover:translate-y-[-2px] hover:shadow-[0_6px_0_rgb(180,140,0)] active:translate-y-[2px] active:shadow-none transition-all uppercase tracking-wider">
            Comenzar Envio
          </button>
          <button className="w-full py-4 bg-[#1e293b] text-white font-bold text-lg rounded-xl border border-white/10 hover:bg-[#334155] transition-colors uppercase tracking-wider">
            Rastrear Pedido
          </button>
        </motion.div>
      ...
      <section className="px-6 py-12 bg-[#0f172a]">
        ...
        <div className="space-y-6">
          ...
          <motion.div
            ...
            className="p-8 bg-[#1e293b]/40 rounded-3xl border border-white/5 backdrop-blur-sm group hover:border-primary/30 transition-all"
          >
      ...
      <section className="px-6 py-12">
        <div className="relative h-64 w-full rounded-3xl overflow-hidden grayscale contrast-125 border border-white/10 shadow-2xl">
          ...
          <div className="absolute bottom-6 left-6 right-6 p-6 bg-[#1e293b]/90 backdrop-blur-xl rounded-2xl border border-white/10 flex flex-col gap-2">
            <div className="flex items-center justify-between text-xs font-bold uppercase tracking-widest">
              <span className="flex items-center text-green-400">
                <span className="w-2 h-2 bg-green-400 rounded-full mr-2 animate-pulse" />
                Rastreo en Vivo
              </span>
              <span className="text-slate-400">Pedido #4829</span>
            </div>
      ...
      {/* Bottom Navigation */}
      <nav className="fixed bottom-0 left-0 right-0 p-4 pb-8 bg-[#1e293b]/80 backdrop-blur-2xl border-t border-white/10 z-50">
        <div className="flex justify-around items-center">
          ...
          <button className="flex flex-col items-center gap-1 text-slate-400">
            ...
            <span className="text-[10px] font-bold uppercase tracking-wider">Rastreo</span>
          </button>
          <button className="flex flex-col items-center gap-1 text-slate-400">
