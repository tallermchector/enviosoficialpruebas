...
const HeroPrototype = () => {
  return (
    <div className="min-h-screen bg-card text-white font-sans selection:bg-primary selection:text-white">
      {/* Header */}
      <header className="flex items-center justify-between p-4 bg-card/50 backdrop-blur-md sticky top-0 z-50 border-b border-white/10">
        ...
        <button className="p-2 bg-card rounded-lg border border-white/10">
      ...
      <section className="relative px-6 pt-16 pb-24 flex flex-col items-center text-center overflow-hidden">
        ...
        <motion.p
          ...
          className="max-w-md text-lg text-muted-foreground mb-10 leading-relaxed"
        >
        ...
        >
          ...
          <button className="w-full py-4 bg-card text-white font-bold text-lg rounded-xl border border-white/10 hover:bg-muted transition-colors uppercase tracking-wider">
            Rastrear Pedido
          </button>
        </motion.div>
      ...
      <section className="px-6 py-12 bg-card">
        ...
        <div className="space-y-6">
          ...
          <motion.div
            ...
            className="p-8 bg-card/40 rounded-3xl border border-white/5 backdrop-blur-sm group hover:border-primary/30 transition-all"
          >
      ...
      <section className="px-6 py-12">
        <div className="relative h-64 w-full rounded-3xl overflow-hidden grayscale contrast-125 border border-white/10 shadow-2xl">
          ...
          <div className="absolute bottom-6 left-6 right-6 p-6 bg-card/90 backdrop-blur-xl rounded-2xl border border-white/10 flex flex-col gap-2">
            <div className="flex items-center justify-between text-xs font-bold uppercase tracking-widest">
              <span className="flex items-center text-green-400">
                <span className="w-2 h-2 bg-green-400 rounded-full mr-2 animate-pulse" />
                Rastreo en Vivo
              </span>
              <span className="text-muted-foreground">Pedido #4829</span>
            </div>
      ...
      {/* Bottom Navigation */}
      <nav className="fixed bottom-0 left-0 right-0 p-4 pb-8 bg-card/80 backdrop-blur-2xl border-t border-white/10 z-50">
