...
export const Footer = () => {
  ...
  return (
    <footer className="pt-32 pb-16 px-4 border-t border-white/5 bg-surface-light relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-16 lg:gap-24 mb-24">
          ...
          <div className="lg:col-span-4">
            <Link href="/" className="flex items-center gap-3 sm:gap-4 mb-8 sm:mb-10 group shrink-0" aria-label="Volver al inicio desde el pie de página">
              ...
              <div className="flex flex-col justify-center">
                <span className="font-display text-orbitron font-black text-xl sm:text-2xl lg:text-3xl tracking-tighter text-slate-900 uppercase italic leading-none mb-1">
                  Envios DosRuedas
                </span>
            ...
            <p className="text-slate-600 text-base mb-12 leading-relaxed font-[family-name:var(--font-roboto)] font-light max-w-sm">
          ...
          <div className="lg:col-span-2">
            <h3 className="font-display text-orbitron font-black mb-10 tracking-[0.3em] text-xxs uppercase text-slate-900/40">Nosotros</h3>
            <ul className="space-y-6">
              {footerLinks.empresa.slice(0, 3).map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="text-slate-600 hover:text-primary transition-all flex items-center gap-3 group text-sm font-[family-name:var(--font-roboto)] font-light">
          ...
          <div className="lg:col-span-2">
            <h3 className="font-display text-orbitron font-black mb-10 tracking-[0.3em] text-xxs uppercase text-slate-900/40">Servicios</h3>
            <ul className="space-y-6">
          ...
          {/* Contact Information */}
          <div className="lg:col-span-4">
            <h3 className="font-display text-orbitron font-black mb-10 tracking-[0.3em] text-xxs uppercase text-slate-900/40">Contacto Rápido</h3>
            <ul className="space-y-8">
              <li className="flex items-start gap-5 group">
                ...
                <div className="flex flex-col">
                  <span className="text-slate-900 font-display text-orbitron text-xxs font-black uppercase tracking-widest mb-1 opacity-40">Ubicación</span>
                  <span className="text-slate-600 text-sm leading-relaxed font-light">Friuli 1972, Mar del Plata</span>
                </div>
              </li>
              ...
              <li className="flex items-center gap-5 group">
                ...
                <div className="flex flex-col">
                  <span className="text-slate-900 font-display text-orbitron text-xxs font-black uppercase tracking-widest mb-1 opacity-40">Teléfono</span>
                  <a href="tel:+542236602699" className="text-slate-600 hover:text-slate-900 transition-colors font-light text-sm">+54 223 660-2699</a>
                </div>
              </li>
              ...
              <li className="flex items-center gap-5 group">
                ...
                <div className="flex flex-col">
                  <span className="text-slate-900 font-display text-orbitron text-xxs font-black uppercase tracking-widest mb-1 opacity-40">Email</span>
                  <a href="mailto:matiascejas@enviosdosruedas.com" className="text-slate-600 hover:text-slate-900 transition-colors font-light text-sm">matiascejas@enviosdosruedas.com</a>
                </div>
              </li>
            </ul>
          </div>
        ...
        <div className="mb-16 grid grid-cols-2 md:grid-cols-4 gap-8 py-10 border-y border-white/5 bg-white/[0.01]">
          {[
            ...
            <div key={i} className="flex flex-col items-center justify-center text-center gap-2 px-4 border-r border-white/5 last:border-r-0">
              ...
              <span className="text-[8px] font-black tracking-[0.4em] text-slate-500 uppercase">{item.label}</span>
              <span className="text-xxs font-black text-slate-900 uppercase tracking-widest">{item.value}</span>
            </div>
          ))}
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-10">
          <div className="flex flex-col gap-2">
            <p className="text-[9px] text-slate-600 uppercase tracking-[0.4em] font-black text-center md:text-left">
              © 2026 Envios DosRuedas. Todos los derechos reservados.
            </p>
          </div>

          <div className="flex items-center gap-10">
            <Link href="/politica-de-privacidad" className="text-[9px] text-slate-600 hover:text-slate-900 uppercase tracking-widest font-black transition-colors">Privacidad</Link>
            <Link href="/terminos-y-condiciones" className="text-[9px] text-slate-600 hover:text-slate-900 uppercase tracking-widest font-black transition-colors">Términos</Link>
