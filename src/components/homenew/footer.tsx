...
export const Footer = () => {
  ...
  return (
    <footer className="pt-32 pb-16 px-4 border-t-2 border-secondary bg-[#0636A5] relative overflow-hidden">
      ...
      <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-white/5 rounded-full blur-[120px] pointer-events-none opacity-50" />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-16 lg:gap-24 mb-24">
          ...
          <div className="lg:col-span-4">
            <Link href="/" className="flex items-center gap-3 sm:gap-4 mb-8 sm:mb-10 group shrink-0" aria-label="Volver al inicio desde el pie de página">
              <div className="relative w-12 h-12 sm:w-14 sm:h-14 rounded-none flex items-center justify-center shrink-0 transition-all group-hover:rotate-6 group-hover:scale-110 drop-shadow-[0_0_10px_rgba(255,255,255,0.2)]">
          ...
          <div className="lg:col-span-2">
            <h3 className="font-display font-black mb-10 tracking-[0.3em] text-xxs uppercase text-white/50">Nosotros</h3>
            <ul className="space-y-6">
              {footerLinks.empresa.slice(0, 3).map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="text-white/80 hover:text-secondary transition-all flex items-center gap-3 group text-sm font-sans font-light">
                    <div className="w-1 h-1 rounded-none bg-white/20 group-hover:bg-secondary group-hover:scale-150 transition-all" />
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div className="lg:col-span-2">
            <h3 className="font-display font-black mb-10 tracking-[0.3em] text-xxs uppercase text-white/50">Servicios</h3>
            <ul className="space-y-6">
          ...
          {/* Contact Information */}
          <div className="lg:col-span-4">
            <h3 className="font-display font-black mb-10 tracking-[0.3em] text-xxs uppercase text-white/50">Contacto Rápido</h3>
            <ul className="space-y-8">
              <li className="flex items-start gap-5 group">
                <div className="w-12 h-12 rounded-none glass-card flex items-center justify-center shrink-0 group-hover:bg-secondary/20 group-hover:border-secondary/40 transition-all bg-white/5 border border-white/10">
              ...
              <li className="flex items-center gap-5 group">
                ...
                <div className="flex flex-col">
                  ...
                  <a href="tel:+542236602699" className="text-white/90 hover:text-secondary transition-colors font-light text-sm">+54 223 660-2699</a>
                </div>
              </li>
              ...
              <li className="flex items-center gap-5 group">
                ...
                <div className="flex flex-col">
                  ...
                  <a href="mailto:matiascejas@enviosdosruedas.com" className="text-white/90 hover:text-secondary transition-colors font-light text-sm">matiascejas@enviosdosruedas.com</a>
                </div>
              </li>
            </ul>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-10">
          ...
          <div className="flex items-center gap-10">
            <Link href="/politica-de-privacidad" className="text-[9px] text-white/60 hover:text-white uppercase tracking-widest font-black transition-colors">Privacidad</Link>
            <Link href="/terminos-y-condiciones" className="text-[9px] text-white/60 hover:text-white uppercase tracking-widest font-black transition-colors">Términos</Link>
